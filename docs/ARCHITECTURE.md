...
- **Extension-based comment style dispatch.** 128 extensions mapped to several comment styles. Unknown extensions try C-style first, then hash. Covers virtually all codebases.
